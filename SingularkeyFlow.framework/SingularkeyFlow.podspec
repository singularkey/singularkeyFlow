#
#  Be sure to run `pod spec lint SingularkeyFLow.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  #spec.homepage         = 'https://github.com/singularkey/iosflowdemo'

  spec.homepage         = 'https://singularkey.com'
  ...
  spec.license = { :type => 'Commercial', :text => 'See https://singularkey.com/' }
  ...
  #  profile URL.
  #
  spec.author               = { 'Singular Key Inc.' => 'info@singularkey.com' }
  # Or just: spec.author    = 'Singular Key Inc.'
  # spec.authors            = { 'Singular Key Inc.' => 'info@singularkey.com' }
  ...
  # spec.source       = { :git => "http://bitbucket.org/invisibleauth/singularkeyiosflow.git", :tag => "#{spec.version}" }
  spec.source       = { :git => "http://bitbucket.org/invisibleauth/singularkeyiosflow.git"}
  ...
  spec.ios.vendored_frameworks = 'SingularkeyFlow.framework'

  spec.dependency 'Singularkey'
